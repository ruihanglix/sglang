...
class TPHunyuanMoE(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        # The official flashinfer path computes the gate under the ambient
        # autocast (bfloat16 during diffusion, matching HunyuanTopKGate).
        # We intentionally do NOT disable autocast here so that the gate
        # precision matches the official model during both diffusion and
